...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-cookie
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-cookie
* https://www.haproxy.com/blog/load-balancing-affinity-persistence-sticky-sessions-what-you-need-to-know/
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#dynamic-cookie-key
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-agent-port
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-agent-inter
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-agent-send
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4.2-http-request%20deny
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4.2-http-request%20set-src
...
* `auth-signin`: Optional, configures the endpoint of the sign in server used to redirect failed requests. The content is parsed by haproxy as a [log-format](https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#8.2.4) string and the result is copied verbatim to the `Location` header of a HTTP 302 response. The default behavior is to use the authentication service response.
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-proto
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-balance
...
[bind keyword doc](#https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-bind).
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-bind
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-monitor-uri (`healthz-port`)
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-weight (`weight` based balance)
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-use-server (`use-server` based selector)
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.2-maxconn (`max-connections`)
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-maxconn (`maxconn-server`)
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-maxqueue (`maxqueue-server`)
...
* `cpu-map`: Custom override specifying the cpu mapping behaviour in the format described [here](https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-cpu-map).
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-cpu-map
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.3.2
...
* https://cbonte.github.io/haproxy-dconv/2.4/management.html#9.3
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-option%20forwardfor
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4.2-option%20httpchk
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-addr
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-port
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-inter
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-weight
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-server-state-file
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-load-server-state-from-file
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#8.2.4
* [`syslog`](#syslog)
* [Auth External](#auth-external) configuration keys.
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-master-worker
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#mworker-max-reloads
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#9.3
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-nbproc
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-bind-process
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-cpu-map
...
* [cpu-map](#cpu-map) configuration key
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-nbthread
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-cpu-map
...
* `auth-signin: "https://<hostname>/oauth2/start?rd=%[path]"` - the content is parsed by haproxy as a [log-format](https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#8.2.4) string and the result is copied verbatim to the `Location` header of a HTTP 302 response. The `rd` query field asks oauth2-proxy to preserve the path provided by the client.
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#7.3.6-req.body_size
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.1-accept-proxy
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-send-proxy
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-send-proxy-v2
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-send-proxy-v2-ssl
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-send-proxy-v2-ssl-cn
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-verify
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-verifyhost
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-sni
...
If using the embedded haproxy, read the [Security considerations](https://cbonte.github.io/haproxy-dconv/2.4/management.html#13) from HAProxy doc before change the starting user.
...
* https://cbonte.github.io/haproxy-dconv/2.4/management.html#13
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-chroot
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-uid
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-gid
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-unix-bind
...
As the default behavior, HAProxy will leave the operating system choose the most appropriate address. However the same source address will be used, even if the network interface has more IP address or other interfaces can also reach the destination, leading to outgoing TCP port exaustion on deployments that needs more than 64k concurrent connections. Using more source IPs allows to bypass the maximum of 64k concurrent connections per instance.
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-source
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-source
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-ssl-default-bind-ciphers
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-ssl-default-bind-ciphersuites
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-ciphers
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.2-ciphersuites
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#tune.ssl.default-dh-param
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-ssl-dh-param-file
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#ssl-engine
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#ssl-mode-async
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.1-crt-list
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#redirect
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-log
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-log-tag
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#3.1-hard-stop-after (`timeout-stop`)
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#2.4 (time suffix)
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#5.1-alpn
...
* https://cbonte.github.io/haproxy-dconv/2.4/configuration.html#4-option%20http-use-htx
